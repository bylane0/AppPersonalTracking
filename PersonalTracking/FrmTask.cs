...
namespace PersonalTracking
{
    public partial class FrmTask : Form
    {
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            task.EmployeeID= Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value);//AS
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (task.EmployeeID == 0)
                ...
                MessageBox.Show("El contenido está vacío");
            else
            {
                if (!isUpdate)
                {
                    ...
                    MessageBox.Show("La tarea fue agregada!");
                    txtTitle.Clear();
                    txtContent.Clear();
                    task = new TASK();
                }
